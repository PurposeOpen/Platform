$(function() {
  ...
  $('textarea.html-editor').livequery(function() { $(this).tinymce($.extend(regularEditor, this.dataset));});
  $('textarea.html-compact-editor').livequery(function() { $(this).tinymce(compactEditor) });
  $('textarea.html-minimal-editor').livequery(function() { $(this).tinymce(minimalEditor) });
});
